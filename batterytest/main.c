 ...
 *
 * This version of the program is designed for use in capturing
 * current and voltage off a deep cycle marine battery.
 * A raw output is used to manage the load.  Data is 2 channels
 ...
 *
 * NOTE: The opto-isolated inputs are not used.
 *
 * RAW_0 is connected to the load.
 *
 */

/*
 * Define the values on RAW_0 that control the load.
 */
#define	LOAD_OFF	0
#define	LOAD_ON		1
 ...
 * calls to the isr.  12,000 = 1KHz, 1,200 = 10KHz, etc.
 *
 * That is further divided by T1DIVIDE to generate calls to
 * the adc ISR.
 */
#define	T1PD		(1196*10)		// 1 KHz
#define	T1DIVIDE	10000			// 0.1 HZ
// #define	T1DIVIDE	1000			// 1 HZ
...
main(void)
{
	...
	/*
	 * Timer 1: 1,000 Hz interrupt source.
	 */
	TMR1IE = 0;
