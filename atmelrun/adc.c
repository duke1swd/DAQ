 ...
 *  0: input channel 0, filtered
 *  1: input channel 1, filtered
 *  2: input channel 2, filtered
 *  3: +v monitor, scaled by 1/4
 *  4: -v monitor, scaled by 1/4
 *  5: unfilered input.
 */
 ...
 *
 * NOTE: the 12 bit sample occupies the high-order 12 bits
 * of adc_value on return.
 */
uns16 adc_value;
