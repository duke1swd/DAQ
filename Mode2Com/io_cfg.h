...
//
// Eventually this must be defined as the right pin.
// for now our debug board doesn't have this feature.
#define usb_bus_sense       1
//
// Current debug board is self powered.
#define self_power          1

// Here are the LED definitions for the debug board
#define mInitAllLEDs()      LATA &= 0xF3; TRISA &= 0xF3;
