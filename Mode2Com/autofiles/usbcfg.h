...
//
// Modified 7/8/8 by Stephen Daniel
...
#define HYBRIDSKY	// Hybrid sky data capture board.  18F2455 based.
	...
	//
	// In the final board we'll be self powered and have to deal
	// with bus sense issues.
	//
	// For the short term we are using a bus-powered board
	// with no ability to sense the USB bus.
	//
