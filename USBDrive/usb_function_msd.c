...
/*
 * Define these two to use only a portion of the SSD card.
 */
#define	FBASE	775		// file offset in sectors
#define	FSIZE	(8*1024*2)	// 8 MB in sectors
#endif // USE_DATAFLASH
    ...
    #ifdef FBASE
    #undef LUNSectorWrite
    #define LUNSectorWrite(bLBA,pDest,Write0)   MDD_SectorWrite((bLBA)+FBASE, pDest, Write0)
    #undef LUNSectorRead
    #define LUNSectorRead(bLBA,pSrc)            MDD_SectorRead((bLBA)+FBASE, pSrc)
    #undef LUNReadCapacity
    #define LUNReadCapacity()                     FSIZE
    #endif //FBASE
#endif
